...
const createDiningMenu = async (req, res) => {
  try {
    ...
    console.error("Error in createDiningItem:", error);
    return res
      .status(500)
...
const getDiningCatogories = async (req, res) => {
  try {
    const sql = `
...
module.exports = { createDiningMenu, getDiningCatogories };
